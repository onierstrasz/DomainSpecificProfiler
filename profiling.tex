...
\lr{Not understandable:} \ugh{This performance issue has been solved a few days after the complain via a quantification of the displayOn: invocation on each objects and metric computation.}
...
\begin{description}
	...
	\item[Method Observer.] This observer listen to the event when an specific method is invoked for any instance of a class.
	\item[Object Observer.] This observer allow us to trigger event for a single instance of a class. This is called object-specific profiling. Some examples of event a single instance can trigger are: message send, message receive, state read and state write.
