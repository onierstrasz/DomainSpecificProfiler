...
This paper gives the essential property an effective domain-specific profiler must meet. Note that we take a rather large definition of profiler by not solely focusing on a timely execution. In this paper, we consider profiling as the activity to record recording and analysis of a program execution. Profiling is often considered essential when one wants to obtain the representation of a program execution.
