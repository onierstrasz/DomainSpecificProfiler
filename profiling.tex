...
\paragraph{Homogeneous operation cost.}
When considering the execution time of a particular operation, each operation must be treated as an atomic and uniform operation, independently of the object receiver. \ab{maybe not... We need to experiment on this}
...
The following code excerpt monitor the 
