...
\jr{we have to clarify this sentence:} The proliferation of meta-models and domain-specific languages builds new abstractions that map to the underlying execution platform in non-trivial ways. Traditional profiling tools fail to display relevant information in the presence of such abstractions.
...
%Mondrian is a crucial component which is used in more than a dozen independent projects. 
%To meet clients performance requirements, Mondrian's authors are paying \ugh{a great} attention to provide fast and scalable rendering. 
In June 2010 a serious performance issue was identified\footnote{\lr{again?} \url{http://bit.ly/g8GjIh}} when \lr{that has nothing to do with our paper:} visualizing an enriched dependency structural matrix~\cite{Lava09a}. 
...
Most programming languages have an structure which models the execution stack.
