...
\lr{These are the points we are addressing, thus it should go to the problem section. No? And in this section we show how we solve them.}\ab{Addressed. if you agree, then remove your comment}

We identified a number of properties domain-specific profilers must fulfill in order to be effective.
